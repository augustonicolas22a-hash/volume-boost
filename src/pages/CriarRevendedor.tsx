        ...
        {step === 'form' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Preencha os dados e pague <strong>R$2</strong> via PIX (teste). O revendedor receberá <strong>5 créditos</strong> iniciais.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="p-4 bg-primary/10 rounded-lg border border-primary/20">
                  <p className="text-sm font-medium text-primary">💰 Taxa de ativação: R$2,00 (teste)</p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">= 5 créditos para o revendedor (teste)</p>
              </div>
